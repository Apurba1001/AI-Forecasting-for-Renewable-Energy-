...
from config import MODEL_DIR, OUTPUT_DIR, TARGET_COLS
    ...
    def predict(self, country_code: str, forecast_date=None) -> dict:
        ...
        for target in TARGET_COLS:
            ...
            try:
                ...
                print(
                    f"   ✅ {clean_target:<15} | Peak: {forecast_series.max():,.0f} MW"
                )
        ...
        if forecasts:
            ...
            print(
                f"   ⚠️ No models found for {country_code}. Check 'models/lightweight' folder."
            )
